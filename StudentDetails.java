...
public void getStudentDetails() {
        // Use the column names from your database logic
        String query = "SELECT studentID, StudentName, sex, RoomNo, MobileNo, LivingStatus " +
        ...
        try (Connection con = ConnectionProvider.getCon();
            ...
            if (rs.next()) {
                // Set the text fields with the data found
                jTextField3.setText(rs.getString("studentID"));
                jTextField1.setText(rs.getString("StudentName"));
                jTextField2.setText(rs.getString("sex"));
                jTextField4.setText(rs.getString("RoomNo"));
                jTextField5.setText(rs.getString("MobileNo"));
                jTextField6.setText(rs.getString("LivingStatus"));
            } else {
...
this.hide();
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentDetails("0").setVisible(true);
            }
        });
    }
